          ...
          <div className="contents text">
            ...
            <div className="links_heading">
              ...
              <div className="links_row">
                ...
                <div className="links_description">fukino89との合作 主にサムネ担当</div>
              </div>
              <div className="links_row">
            ...
            <div className="links_heading">
              ...
              <div className="links_row">
                <Link className="link" to="https://odaibako.net/u/maakunn89">
                  お題箱
                </Link>
                <div className="links_description">たまに描きます 正式なリクエストはSKebへ</div>
              </div>
              <div className="links_row">
                <Link className="link" to="https://www.amazon.jp/hz/wishlist/ls/1O26K5IMB834T?ref_=wl_share">
                  ほしいものリスト
                </Link>
